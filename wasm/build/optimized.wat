(module
 ...
 (data (i32.const 1624) "\05\00\00\00\08\00\00\00\01")
 (data (i32.const 1644) "\1c")
 (data (i32.const 1656) "\06\00\00\00\08\00\00\00\02")
 (data (i32.const 1676) "<")
 ...
 (data (i32.const 1836) "\01\t\00\00\02\00\00\00\01\1a\00\00\02")
 (table $0 3 funcref)
    ...
    block $invalid
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner0 $folding-inner0 $folding-inner1 $folding-inner1 $invalid
      end
      return
     end
     return
 ...
 (func $assembly/index/Correct (param $0 i32) (param $1 i32) (param $2 f64) (param $3 i32) (result i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $export:assembly/index/Correct (param $0 i32) (param $1 i32) (param $2 i32) (param $3 f64) (param $4 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
